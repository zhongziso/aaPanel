...
wget -O "/root/LinuxPanel_EN-6.8.23.zip" "https://github.com/zhongziso/aapanel/releases/download/1.0/LinuxPanel_EN-6.8.23.zip"
red "Download complete, downgrading."
unzip LinuxPanel_EN-6.8.23.zip
cd /root/panel
wget -O "/root/panel/downgrade.sh" "https://raw.githubusercontent.com/zhongziso/aapanel/main/script/downgrade.sh" 
...
wget https://raw.githubusercontent.com/zhongziso/aaPanel/main/resource/repair.json
chattr +i /www/server/panel/data/repair.json
...
wget -O /root/chinese.zip https://github.com/zhongziso/aaPanel/releases/download/1.2/aapanel_chinese-6.8.21.zip
...
function start_menu(){
    ...
    purple " https://github.com/zhongziso/aaPanel"
    yellow " ————————————————————————————————————————————————"
